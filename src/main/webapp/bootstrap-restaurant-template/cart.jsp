...
<body>
    <div class="container-fluid bg-white p-0">
        ...
        <div class="container-fluid py-5">
            <div class="container-fluid">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <h1 class="mb-5">Edit or Check out</h1>
                </div>
                <div class="row g-4" id="dataContainer">
        ...
        <form action="../FoodorderUpdate" method="post">
    <center>
        <h6>
            <button href="#" class="btn btn-lg"
                style="display:inline; margin: 4px 2px; background-color: #7FFF00" type="submit">
                CHECK OUT
            </button>
        </h6>
    </center>
    ...
    <script src="js/main.js"></script>
			       <script> 
			           ...
			           fetch('../FoodDrinkOrderServlet') 
			               .then(response => response.text()) 
			               .then(data => document.getElementById('dataContainer').innerHTML = data); 
			       </script> 
			       
     <script>
  function deleteData(foodActualName) {
    if (confirm("Are you sure you want to delete this data?")) {
      // Send an AJAX request to the server
      var xhr = new XMLHttpRequest();
      xhr.open("POST", "../DeleteDataServlet", true);
      ...
      xhr.send("foodId=" + foodActualName); // Update parameter name here
    }
  }
</script>
